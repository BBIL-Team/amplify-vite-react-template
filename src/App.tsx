...
function App() {
 ...
 const saveChanges = () => {
  ...
  return (
   <div style={{ top: '0', display: 'flex', flexDirection: 'column', padding: '0', width: '90vw', margin: '0', boxSizing: 'border-box', backgroundColor: '#E2E2E2', position: 'relative',alignItems: 'center' }}>
      <header>
